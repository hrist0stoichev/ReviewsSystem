...
type Config struct {
	...
	ReadTimeout    time.Duration `env:"SERVER_READ_TIMEOUT" envDefault:"3s"`
	WriteTimeout   time.Duration `env:"SERVER_WRITE_TIMEOUT" envDefault:"3s"`
	IdleTimeout    time.Duration `env:"SERVER_IDLE_TIMEOUT" envDefault:"3s"`
